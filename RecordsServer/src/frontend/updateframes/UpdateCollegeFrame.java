 ...
 * @author Fego
 */
public class UpdateCollegeFrame extends AbstractUpdateFrame {

    /**
     * Creates new form UpdateCollegeFrame
     */
    private UpdateCollegeFrame() {
        initComponents();
    }

    public UpdateCollegeFrame(MainServer server, College college) {
        this();
        this.server = server;
    ...
    private void initComponents() {
        ...
        btnCreate.setText("UPDATE COLLEGE");
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        if (confirmAction("Proceed With College Update?")) {
            System.out.println("College update confirmed");
            if (validateAllFields()) {
                String collegeQuery = String.format("Update Colleges set CollegeName = '%s', CollegeFullName = '%s' where CollegeID = %d;",
                        txtCollegeName.getText().trim(),
                        txtCollegeFull.getText().trim(),
                        college.getCollegeId());

                boolean collegeUpdated = server.sendUpdateQuery(collegeQuery);

                if (collegeUpdated) {
                    displayMessage("College  has been updated", "College Update Successful");
                    dispose();
                } else {
                    displayErrorMessage("Error in updating college. Contact admin", "Update Failed");
                    dispose();
                }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
       if(confirmAction("Exit update college")) dispose();
    ...
    protected final void initPanel() {
        ...
        txtCollegeFull.setText(college.getFullCollegeName());
    }
